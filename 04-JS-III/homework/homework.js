...
function agregarItemAlFinalDelArray(array, elemento) {
  ...
  // y devuelve el array
  // Tu código:
  const agregarItem = array.push(elemento)
  return array;
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
   let contador =  agregarNumeros(resultadosTest);
...
function mesesDelAño(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    if (valorActual === "Enero" || valorActual === "Marzo" || valorActual === "Noviembre") {
